...
<head>
	...
	<script>
		...
		function searchChartTerm(f){
			...
			case "bar":
				readyChart(startT,endT,'all')
				break;
			case "line":
				readyAjaxChart(startT,endT,'all')
				break;
			default :
				alert('잘못된 접근입니다.')
				break;
...
<div id="wrap">
		...
		<div id="bbs_search">
			...
			<form name="search" method="post">
				<input type="date" id="start" name="start" value="2021-06-01" min="2021-06-01">	
				<strong>부터</strong>
				<input type="date" id="end" min="2021-06-01">	
				<strong>까지</strong>
